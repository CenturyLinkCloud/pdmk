...
*/
	...
	bind: function() {
		...
		this.element.bind(eventNames, function(event, xtra /* JW */ ){
			...
			try {
				switch(event.type) {
				case "click":
					return ( o.onClick && o.onClick.call(tree, dtnode, event, xtra /* JW */ )===false ) ? false : dtnode._onClick(event);
				case "dblclick":
					return ( o.onDblClick && o.onDblClick.call(tree, dtnode, event, xtra /* JW */ )===false ) ? false : dtnode._onDblClick(event);
				case "keydown":
					return ( o.onKeydown && o.onKeydown.call(tree, dtnode, event, xtra /* JW */ )===false ) ? false : dtnode._onKeydown(event);
				case "keypress":
					return ( o.onKeypress && o.onKeypress.call(tree, dtnode, event, xtra /* JW */ )===false ) ? false : dtnode._onKeypress(event);
				}
			} catch(e) {
